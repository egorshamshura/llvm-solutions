...
void hw::ADDInstr::build_ir(uint64_t PC, ir_data data) {
  data.builder.CreateStore(
      data.builder.CreateAdd(load64(_r2, data.regFile, data.builder), load64(_r3, data.regFile, data.builder)),
...
void hw::ANDiInstr::build_ir(uint64_t PC, ir_data data) {
  data.builder.CreateStore(data.builder.CreateAnd(load64(_r2, data.regFile, data.builder), data.builder.getInt64(_r3)),
                           GEP2_64(_r1, data.regFile, data.builder));
}
...
void hw::ANDInstr::build_ir(uint64_t PC, ir_data data) {
  data.builder.CreateStore(
      data.builder.CreateAnd(load64(_r2, data.regFile, data.builder), load64(_r3, data.regFile, data.builder)),
      GEP2_64(_r1, data.regFile, data.builder));
}
...
void hw::SUBInstr::build_ir(uint64_t PC, ir_data data) {
  data.builder.CreateStore(
      data.builder.CreateSub(load64(_r2, data.regFile, data.builder), load64(_r3, data.regFile, data.builder)),
      GEP2_64(_r1, data.regFile, data.builder));
}
...
void hw::MULInstr::build_ir(uint64_t PC, ir_data data) {
  data.builder.CreateStore(
      data.builder.CreateMul(load64(_r2, data.regFile, data.builder), load64(_r3, data.regFile, data.builder)),
      GEP2_64(_r1, data.regFile, data.builder));
}
...
void hw::DIVInstr::build_ir(uint64_t PC, ir_data data) {
  data.builder.CreateStore(
      data.builder.CreateSDiv(load64(_r2, data.regFile, data.builder), load64(_r3, data.regFile, data.builder)),
      GEP2_64(_r1, data.regFile, data.builder));
}
...
void hw::REMInstr::build_ir(uint64_t PC, ir_data data) {
  data.builder.CreateStore(
      data.builder.CreateSRem(load64(_r2, data.regFile, data.builder), load64(_r3, data.regFile, data.builder)),
      GEP2_64(_r1, data.regFile, data.builder));
}
...
void hw::XORInstr::build_ir(uint64_t PC, ir_data data) {
  data.builder.CreateStore(
      data.builder.CreateXor(load64(_r2, data.regFile, data.builder), load64(_r3, data.regFile, data.builder)),
      GEP2_64(_r1, data.regFile, data.builder));
}
...
void hw::INC_NEiInstr::build_ir(uint64_t PC, ir_data data) {
  ...
  Value* arg1 = data.builder.CreateAdd(load, data.builder.getInt64(1));
...
void hw::SUBiInstr::build_ir(uint64_t PC, ir_data data) {
  data.builder.CreateStore(data.builder.CreateSub(load64(_r2, data.regFile, data.builder), data.builder.getInt64(_r3)),
                           GEP2_64(_r1, data.regFile, data.builder));
}
...
void hw::BR_CONDInstr::build_ir(uint64_t PC, ir_data data) {
  data.builder.CreateCondBr(data.builder.CreateTrunc(load64(_r1, data.regFile, data.builder), data.builder.getInt1Ty()),
...
void hw::PUT_PIXELInstr::build_ir(uint64_t PC, ir_data data) {
  data.builder.CreateCall(data.FuncMap.at("simPutPixelFunc"),
                          {data.builder.CreateIntCast(load64(_r1, data.regFile, data.builder),
                                                      Type::getInt32Ty(data.builder.getContext()), false),
                           data.builder.CreateIntCast(load64(_r2, data.regFile, data.builder),
                                                      Type::getInt32Ty(data.builder.getContext()), false),
                           data.builder.CreateIntCast(load64(_r3, data.regFile, data.builder),
                                                      Type::getInt32Ty(data.builder.getContext()), false)});
}
...
void hw::RAND64Instr::build_ir(uint64_t PC, ir_data data) {
  data.builder.CreateStore(data.builder.CreateIntCast(data.builder.CreateCall(data.FuncMap.at("simRandFunc")),
                                                      Type::getInt64Ty(data.builder.getContext()), false),
                           GEP2_64(_r1, data.regFile, data.builder));
}
...
void hw::ALLOCInstr::build_ir(uint64_t PC, ir_data data) {
  data.builder.CreateStore(
      data.builder.CreateAlloca(Type::getInt8Ty(data.builder.getContext()), data.builder.getInt32(_r2)),
      GEP2_64(_r1, data.regFile, data.builder));
}
...
void hw::READ64Instr::build_ir(uint64_t PC, ir_data data) {
  ...
  auto* loaded_value =
      data.builder.CreateLoad(Type::getInt64Ty(data.builder.getContext()),
                              data.builder.CreateIntToPtr(final_ptr, data.builder.getInt8Ty()->getPointerTo()));
  data.builder.CreateStore(loaded_value, GEP2_64(_r1, data.regFile, data.builder));
}

void hw::WRITE64Instr::execute(CPU& cpu) {
  cpu.m_mem[cpu.m_regFile[_r1] + cpu.m_regFile[_r2]] = cpu.m_regFile[_r3];
}

hw::Instr_t hw::WRITE64Instr::instr() {
...
void hw::WRITE64iiInstr::execute(CPU& cpu) {
  cpu.m_mem[cpu.m_regFile[_r1] + _r2] = _r3;
}

hw::Instr_t hw::WRITE64iiInstr::instr() {
...
void hw::WRITE64riInstr::execute(CPU& cpu) {
  cpu.m_mem[cpu.m_regFile[_r1] + cpu.m_regFile[_r2]] = _r3;
}

hw::Instr_t hw::WRITE64riInstr::instr() {
...
void hw::ADDiInstr::build_ir(uint64_t PC, ir_data data) {
  data.builder.CreateStore(data.builder.CreateAdd(load64(_r2, data.regFile, data.builder), data.builder.getInt64(_r3)),
                           GEP2_64(_r1, data.regFile, data.builder));
}
